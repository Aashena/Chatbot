...
function loadChatWidget(customNamespace, apiBase) {
    ...
    style.textContent = `
      ...
      #chat-widget-send:hover { transform: scale(1.05) !important; }
    ...
    chatButton.innerHTML = '<span>Chat with Your Bot</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>';
    ...
    chatWindow.innerHTML = `
      <div id="chat-widget-header">
        ...
        <div id="chat-widget-header-actions">
          <button id="chat-widget-clear">Clear Chat</button>
